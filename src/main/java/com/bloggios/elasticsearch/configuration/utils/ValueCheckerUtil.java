 ...
 * Package - com.bloggios.post.provider.utils
...
public class ValueCheckerUtil {
    ...
    public static void isNullOrEmpty(String data, String errorCode) {
        if (Objects.isNull(data) || ObjectUtils.isEmpty(data)) {
            throw new ElasticsearchException(errorCode);
        }
    }

    public static void isNullOrEmpty(Object data, String errorCode) {
        if (Objects.isNull(data) || ObjectUtils.isEmpty(data)) {
            throw new ElasticsearchException(errorCode);
        }
    }
