...
package com.bloggios.elasticsearch.configuration.payload;
 ...
 * Package - com.bloggios.elasticsearch.configuration.payloads
...
public class ListRequest {
    ...
    private List<SearchFilter> field;
    private List<String> texts;
    private List<String> searchTextsNgram;
    private List<SearchFilterNgram> searchFieldsNgram;
}
